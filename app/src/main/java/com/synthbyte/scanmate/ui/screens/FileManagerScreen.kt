            ...
            Card(
                ...
                Row(modifier = Modifier.padding(16.dp), verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Column(modifier = Modifier.padding(start = 12.dp)) {
                        Text("Your document library", fontWeight = FontWeight.Bold, style = MaterialTheme.typography.titleMedium)
                        Text("Find exported scans, PDFs, OCR text, QR codes, ZIP backups and signatures.", color = MaterialTheme.colorScheme.onSurfaceVariant)
                    }
                }
            }
